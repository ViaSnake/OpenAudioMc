...
!function (e) {
  ...
  var Y = function () {
    function Y(e) {
      ...
      if (this.openAudioMc = e, -1 < window.location.href.indexOf("debug")) {
        console.log("Allowing debug");var t = new (window.AudioContext || window.webkitAudioContext)(),
            i = t.createPanner();i.panningModel = "HRTF", i.distanceModel = "inverse", i.refDistance = 1, i.maxDistance = 10, i.rolloffFactor = 1, i.coneInnerAngle = 1, i.coneOuterAngle = 360, i.coneOuterGain = 0, i.positionX.value = -387.5, i.positionY.value = 73, i.positionZ.value = 275.5;var _o3 = t.createBufferSource(),
        ...
        }, _s4.send();var n = t.listener;n.setOrientation(0, 0, -1, 0, 1, 0), e.socketModule.registerHandler("ClientPlayerLocationPayload", function (e) {
          var t = e.x,
              i = e.y,
              o = e.z,
              s = e.pitch,
              r = e.yaw;var a = new Z(t, i, o),
              l = _this14.calculateOffset(t, i, o, s, r, 1);console.log(l), n.forwardX.value = l.x, n.forwardY.value = l.y, n.forwardZ.value = l.z, n.positionX.value = a.x, n.positionY.value = a.y, n.positionZ.value = a.z, n.upX.value = a.x, n.upY.value = a.y, n.upZ.value = a.z, console.log("update loc");
        }), _o3.start(0);
    ...
    Y.prototype.calculateOffset = function calculateOffset(e, t, i, n, o, s) {
      var r = this.degreesToRadians(o),
          a = Math.cos(r),
          l = Math.sin(n);return new Z(e + a * s, t, i + l * s);
    };

    Y.prototype.normalizeYaw = function normalizeYaw(e) {
